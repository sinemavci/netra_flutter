...
typedef OnCacheHit =
    void Function(RequestOptions request, int ageMs, int ttlMs);
typedef OnCacheStored =
    void Function(RequestOptions request, int ageMs, int sizeByte);
typedef OnCacheExpired =
    void Function(
...
typedef OnQueuedRequestSuccess = void Function(String url, Response response);
