...
interface NetraHostApi {
  ...
  fun post(clientId: String, requestOptions: String, callback: (Result<String?>) -> Unit)
  fun put(clientId: String, requestOptions: String, callback: (Result<String?>) -> Unit)
  fun patch(clientId: String, requestOptions: String, callback: (Result<String?>) -> Unit)
  fun delete(clientId: String, requestOptions: String, callback: (Result<String?>) -> Unit)
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: NetraHostApi?, messageChannelSuffix: String = "") {
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val clientIdArg = args[0] as String
            val requestOptionsArg = args[1] as String
            api.post(clientIdArg, requestOptionsArg) { result: Result<String?> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(NetraControllerPigeonPigeonUtils.wrapError(error))
              } else {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.netra_flutter.NetraHostApi.put$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val clientIdArg = args[0] as String
            val requestOptionsArg = args[1] as String
            api.put(clientIdArg, requestOptionsArg) { result: Result<String?> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(NetraControllerPigeonPigeonUtils.wrapError(error))
              } else {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.netra_flutter.NetraHostApi.patch$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val clientIdArg = args[0] as String
            val requestOptionsArg = args[1] as String
            api.patch(clientIdArg, requestOptionsArg) { result: Result<String?> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(NetraControllerPigeonPigeonUtils.wrapError(error))
              } else {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.netra_flutter.NetraHostApi.delete$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val clientIdArg = args[0] as String
            val requestOptionsArg = args[1] as String
            api.delete(clientIdArg, requestOptionsArg) { result: Result<String?> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(NetraControllerPigeonPigeonUtils.wrapError(error))
              } else {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.netra_flutter.NetraHostApi.on$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val clientIdArg = args[0] as String
            val eventNameArg = args[1] as String
            val eventIdArg = args[2] as String
            api.on(clientIdArg, eventNameArg, eventIdArg) { result: Result<Boolean> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(NetraControllerPigeonPigeonUtils.wrapError(error))
              } else {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.netra_flutter.NetraHostApi.off$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val clientIdArg = args[0] as String
            val eventIdArg = args[1] as String
            api.off(clientIdArg, eventIdArg) { result: Result<Boolean> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(NetraControllerPigeonPigeonUtils.wrapError(error))
              } else {
